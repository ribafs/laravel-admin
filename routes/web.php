...
Route::resource('clientsp', 'App\Http\Controllers\ClientController');
Route::resource('productsp', 'App\Http\Controllers\ProductController');

Route::get('/', function () {
    return view('welcome');
});

Route::get('/public', 'App\Http\Controllers\ClientController@index');
